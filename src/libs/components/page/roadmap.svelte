<script>
	import Checbox from '$libs/components/fundamental/Checbox.svelte';
...
>    <i>TBD</i></div>
Atleast 3 SCFulfilled products are designed, manufacture & made available for distribution
...
>    <i>TBD</i></div>
Lucrative system that rewards the makers that people are most appreciative of. Other factors are considered too.

<b>Tiger</b> - Tier 1 SCApproved
<b>Osprey</b> - SCFulfilled
<b>Rhino</b> - Tier 2 SCApproved
<b>Peacock</b> - Tier 3 SCApproved
<b>Bee</b> - consumer

<div class="opacity-60"><span>For more detailed progress,
Follow us on</span>   <a
				target="_blank"
				href="https://discord.gg/UQ74TQfMqM"
				rel="noopener noreferrer"
				><Icon icon="ph:discord-logo-duotone" class="text-3xl inline-block" /></a
			>   <a rel="noopener noreferrer" target="_blank" href="https://github.com/TheAnimatrix/SCWeb"
				><Icon icon="ph:github-logo-duotone" class="text-3xl inline-block" /></a
			></div></pre>
</div>
