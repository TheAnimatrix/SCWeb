	...
	<div class="mx-auto max-w-3xl px-4 py-8 md:py-12">
		...
		<div class="mt-8 text-center">
			<div
				...
				<Icon icon={F.checkCircle} class="size-7 text-green-600 dark:text-green-400" aria-hidden="true" />
			</div>
		...
		<div class="mt-8 space-y-4">
			<section class="rounded-lg border border-border bg-card p-5">
				...
				<p class="mt-4 text-sm text-muted-foreground">
					A confirmation email is on its way. Order tracking updates will also be sent to your registered
